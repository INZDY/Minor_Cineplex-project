  ...
  const HandlerNavClick = (selectedComponent) => {
    ...
    <nav className="nav">
      <ul>
        ...
        <li>
          <a onClick={() => HandlerNavClick(<BranchRevenue />)}>Branch revenue</a>
        </li>
        <li>
          <a onClick={() => HandlerNavClick(<SeatPopularity />)}>Seat popularity</a>
        </li>
        <li>
          <a onClick={() => HandlerNavClick(<AiringLanguage />)}>Airing language</a>
        </li>
        <li>
          <a onClick={() => HandlerNavClick(<ShowtimePopularity />)}>Showtime popularity</a>
        </li>
      </ul>
    </nav>
    {component}
